        ...
        <div className="w-full flex flex-col-reverse md:flex-row items-center justify-between px-6 md:px-28 pt-52 md:pt-40 pb-10 md:pb-20 gap-10 md:gap-0">
            ...
            <div className="max-w-3xl text-left">
                ...
                <div className="flex flex-wrap gap-4">
                    <Link href={"/contactus"} className=' z-50 hover:bg-yellow hover:rounded-md'>
                        <Button
                            size="lg"
                            className="bg-yellow hover:bg-yellow hover:rounded-md text-blue font-semibold px-8"
                        >
                            Contact Us
                        </Button>
                    </Link>
                    <Link href={"/pricing"} className=' z-50 hover:bg-transparent hover:rounded-md'>
                    <Button
                        size="lg"
